...
public class ProductController {
	...
	public ResponseEntity<String> updateProduct(@Valid @PathVariable("pid") int pid, @RequestBody Product product) {
	...
	public ResponseEntity<String> deleteProduct(@Valid @PathVariable("pid") int pid) {
	...
	public ResponseEntity<?> deleteByPname(@Valid @PathVariable("pname") String pname) {
